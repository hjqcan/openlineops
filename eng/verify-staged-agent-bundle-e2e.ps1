...
$publicAgentIdentity = [ordered]@{
    ...
    hasLinkedToken = [bool]$privateRabbitMqEvidence.agentHostIdentity.HasLinkedToken
...
$publicRestartedAgentIdentity = [ordered]@{
    ...
    hasLinkedToken = [bool]$privateRabbitMqEvidence.restartedAgentHostIdentity.HasLinkedToken
