    ...
    public static void ValidateHelperIdentity(string helperServiceName)
    {
                ...
                StringComparison.Ordinal)))
        {
            throw new InvalidOperationException(
                "The token-transfer helper must run as the exact virtual service account in a primary, unlinked, unrestricted token with its service-logon and same service SID groups enabled and without an Administrators SID.");
        }
    }
