...
public sealed class PostgresRuntimeSessionRepository :
    ...
    IAsyncDisposable
{
    ...
    public PostgresRuntimeSessionRepository(string connectionString)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        command.Parameters.AddWithValue("last_transition_at_utc", session.LastTransitionAtUtc);
