...
public static class PythonScriptExecutionScope
{
        ...
        PythonScriptExecutionScopeRequest request)
    {
        ...
        scope.Set("operation_id", request.OperationId);
        scope.Set("operation_attempt", request.OperationAttempt);
        scope.Set("station_system_id", request.StationSystemId);
        scope.Set("product_model_id", request.ProductModelId);
        scope.Set("production_unit_identity_input_key", request.ProductionUnitIdentityInputKey);
        scope.Set("production_unit_identity_value", request.ProductionUnitIdentityValue);
