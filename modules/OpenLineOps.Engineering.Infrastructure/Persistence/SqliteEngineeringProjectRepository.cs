...
public sealed class SqliteEngineeringProjectRepository : IEngineeringProjectRepository, IDisposable
{
    ...
    public SqliteEngineeringProjectRepository(string connectionString)
    {
